...
const userInput3 = <HTMLInputElement>document.getElementById("user-input");
console.log(userInput3.value);

//same approac
const userInput4 = document.getElementById("user-input") as HTMLInputElement;
console.log(userInput4.value);

// another approach when we we are not sure the input is existed or not
if (userInput) {
  let value = (userInput as HTMLInputElement).value;
  console.log(value);
}
